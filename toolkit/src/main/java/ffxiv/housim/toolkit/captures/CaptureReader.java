...
public class CaptureReader {
    ...
    private static Geometry read(String name, List<String> lines) {
        ...
        log.info("vertex:{}, data:{}", vCount - 1, vertices[vCount - 1].index);
        ...
        try {
            BinaryExporter.getInstance().save(geom, new File(name + ".j3o"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return geom;
    ...
    public static void main(String[] args) {
        String[] files = {"w1i1_fl_base", "w1i1_fl_1st", "w1i1_wl_base", "w1i1_wl_1st",
