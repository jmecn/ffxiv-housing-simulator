...
import ffxiv.housim.saintcoinach.scene.sgb.SgbEntryType;
...
public class LgbEntryLight implements ILgbEntry {
    ...
    public LgbEntryLight(PackCollection packs, ByteBuffer buffer, int offset) {
