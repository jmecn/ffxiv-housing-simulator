...
public class SgbGroupEntryClickableRange implements ISgbGroupEntry {
    ...
    // following 8 bytes 0x00

    @Getter
    private final String name;

    public SgbGroupEntryClickableRange(PackCollection packs, ByteBuffer buffer, int offset) {
