...
public final class Hash {
    ...
    public static int computeCRC(byte[] bytes, int offset, int length) {
        ...
        for (int i = 0; i < cbRunningLength / 4; ++i) {
            ...
            dwCRC = crc_table_0f091d0[dwCRC & 0xFF] ^
                    crc_table_0f08dd0[(dwCRC >>> 8) & 0xFF] ^
                    crc_table_0f089d0[(dwCRC >>> 16) & 0xFF] ^
                    crc_table_0f085d0[(dwCRC >>> 24) & 0xFF];
        }
