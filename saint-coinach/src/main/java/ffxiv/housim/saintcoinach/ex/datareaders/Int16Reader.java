...
public class Int16Reader extends DataReader<Short> {
    @Override
    ...
    @Override
    public Short read(ByteBuffer buffer, Column col, IDataRow row) {
    ...
    @Override
    public Short read(ByteBuffer buffer, int offset) {
        buffer.position(offset);
        return buffer.getShort();
    }
}
